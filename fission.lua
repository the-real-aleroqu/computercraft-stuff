...
function reactor:addBurnRate(value)
    ...
    newBurnRate = math.max(math.min(newBurnRate, adapter.getMaxBurnRate()), 0) -- Concat the value
...
local mainFrame = basalt.createFrame()
    ...
    local rateEnormousDecrement = mainFrame:addButton()
                                :setPosition(5,34)
                                :setSize(4,1)
                                :setText("<<<<")
                                :onClick(function()
                                    reactor:addBurnRate(-100)
                                    burnRateValue:setText(string.format("%.1f", reactor.burnRate))
                                end)
    local rateHugeDecrement = mainFrame:addButton()
                                :setPosition(10,34)
                                :setSize(3,1)
                                :setText("<<<")
                                :onClick(function()
                                    reactor:addBurnRate(-10)
                                    burnRateValue:setText(string.format("%.1f", reactor.burnRate))
                                end)
    ...
    local rateHugeIncrement = mainFrame:addButton()
                                :setPosition(33,34)
                                :setSize(3,1)
                                :setText(">>>")
                                :onClick(function()
    ...
    local rateEnormousIncrement = mainFrame:addButton()
                                :setPosition(37,34)
                                :setSize(4,1)
                                :setText(">>>>")
                                :onClick(function()
